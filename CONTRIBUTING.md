...
4. Add translations to `Sources/Localization.swift` for new UI copy. `L()` follows macOS language preferences. `REMOTEMETER_LANGUAGE=en` or `zh-Hans` is a test/demo override, not a system-wide setting.
